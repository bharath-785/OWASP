...
This is informal, single-session manual testing — not a rigorous or statistically meaningful evaluation. Small sample of payloads, small sample of models, no automated fuzzing across phrasings. Treat these as directional observations and starting hypotheses, not conclusions.

## Next

LLM02 — Sensitive Information Disclosure: testing whether *normal, non-adversarial* use can cause the same agent to leak something it shouldn't, without any injected attacker content at all.
